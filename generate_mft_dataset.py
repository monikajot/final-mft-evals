...
if __name__ == "__main__":
    ...
    print(response)
    name = "insert-dataset-file-name"
    data = run_dataset_generation(output_filename=f"{name}.csv", num_examples=10, only_flag="ONLY", example=True, rules_clear_check=False, mft_explanation=True, mfv_examples=False, previous_examples=False)
